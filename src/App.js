...
export default class App extends Component {
  ...
  _calcular() {
    if (
      this.state.peso.includes(',') ||
      this.state.peso.includes('.') ||
      this.state.altura.includes(',') ||
      this.state.altura.includes('.')
    )
            ...
            <div className="ui-g ui-fluid">
              <div className="ui-g-12">
                ...
                <input
                  ...
                  onChange={this.handlePesoChange.bind(this)}
                />
              </div>
              ...
              <div className="ui-g-12">
                ...
                <input
                  ...
                  onChange={this.handleAlturaChange.bind(this)}
                />
              </div>

              <div className="ui-g-12">
                <button type="button" onClick={() => this._calcular()}>
                  Calcular
                </button>
              </div>
            </div>
